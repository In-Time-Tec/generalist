...
export const instructions = definePage({
  ...
  content: [
    ...
    p(
      ...
      ", provide it through ",
      code("Instructions.layer"),
      ", and let Agent render the providers. TurnPolicy instruction overrides are independent: they prepend a system message once to the selected follow-up prompt, and that message remains in chat history.",
    ),
