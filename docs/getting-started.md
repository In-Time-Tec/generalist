...
<Warning>
These instructions target Generalist 0.65.3. Use matching Effect packages and do not substitute an older Generalist release expecting the same APIs. To run directly from a checkout, use the [repository examples](/start/examples).
</Warning>
...
bun init -y
bun add generalist@0.65.3 effect@4.0.0-rc.112 @effect/ai-openai@4.0.0-rc.112
