...
export const coreToolsReference = definePage({
  ...
  content: [
    ...
    h2("tool-placement", "ToolPlacement"),
    p(
      code("ToolPlacement"),
      " contains the request, response, route, and retry contracts used when a custom host places tools on a client, remote worker, MCP server, or sandbox. A placement endpoint returns ",
      code("ToolPlacement.PlacementResponse = Success | DomainFailure | Suspend"),
      "; adapt that value to the loop's schema-checked outcome with ",
      code("ToolPlacement.placementOutcome.fromResponse(placement, tool, response)"),
      ". Prefer the higher-level ",
      code("ToolExecutor.client"),
      ", ",
      code("remote"),
      ", ",
      code("mcp"),
      ", or ",
      code("sandbox"),
      " constructors unless you are implementing a placement adapter.",
    ),
