...
Generalist is an Effect-native framework for building specialized or general agents inside an application. It gives developers one composable model for prompts, tools, model providers, memory, skills, streaming, and a portable durable Runtime.
