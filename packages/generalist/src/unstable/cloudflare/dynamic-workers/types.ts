import { protocolVersion } from "../../../core/program/code-executor.js"
import { LogLevel, ProgramMemberKey, ProgramOperationName } from "../../../core/program/capabilities.js"
...
const member = Schema.Struct({ member: ProgramMemberKey, input: Schema.Unknown })
