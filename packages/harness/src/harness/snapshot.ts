...
export const CODEC = "@batonfx/harness/snapshot"
...
export class SnapshotMismatch extends Schema.TaggedErrorClass<SnapshotMismatch>()("@batonfx/harness/SnapshotMismatch", {
  expected: Schema.String,
  actual: Schema.String,
}) {}

/** @experimental A pinned snapshot payload is not a valid harness state. */
export class SnapshotInvalid extends Schema.TaggedErrorClass<SnapshotInvalid>()("@batonfx/harness/SnapshotInvalid", {
