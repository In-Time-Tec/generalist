...
The install command targets Generalist 0.65.2. To run directly from the checkout, use the [repository example](/start/examples) rather than installing an older version with different APIs.
...
bun init -y
bun add effect@4.0.0-rc.112 generalist@0.65.2 @effect/ai-openrouter@4.0.0-rc.112 @effect/platform-bun@4.0.0-rc.112 @aws-sdk/client-s3@3.1124.0 @smithy/fetch-http-handler@5.7.2
```
...
mkdir web && cd web
bun init -y
bun add effect@4.0.0-rc.112 generalist@0.65.2 foldkit@0.148.2
bun add -d vite
```
