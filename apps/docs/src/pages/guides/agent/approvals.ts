import approvalsLayer from "virtual:source/src/snippets/guides/agent/approvals/layer.ts"
import needsApprovalTool from "virtual:source/src/snippets/guides/agent/approvals/needs-approval-tool.ts"
import suspendAndResume from "virtual:source/src/snippets/guides/agent/approvals/suspend-and-resume.ts"
import suspendAndResumeExpected from "virtual:source/src/snippets/guides/agent/approvals/suspend-and-resume.expected.txt"
