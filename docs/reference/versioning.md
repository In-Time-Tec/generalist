...
description: "The 0.65.0 package, experimental policy, Effect compatibility, and release train."
---
...
| ------------ | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `generalist` | `0.65.0` | Core, object durability, Runtime, exact AI leaves, MCP, memory, instructions and skills, test hosts, transport, integrations, and the supported Cloudflare and Rivet compute adapters |
...
| ---------- | -------------- | --------------------------------------------------- |
| `0.65.0`   | `4.0.0-rc.112` | The exact peer and tested workspace catalog version |
