...
/** @experimental */
export class NotFound extends Schema.TaggedError<NotFound>()("tenetkit/ai/ModelMetadataNotFound", {
...
/** @experimental */
export class ModelCatalog extends Context.Service<ModelCatalog, Service>()("tenetkit/ai/model-catalog/ModelCatalog") {}
