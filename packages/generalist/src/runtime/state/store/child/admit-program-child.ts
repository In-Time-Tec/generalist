...
export const admitProgramChild: {
  (input: AdmitProgramChildInput): (state: RuntimeState) => AdmitProgramChildResult
  (state: RuntimeState, input: AdmitProgramChildInput): AdmitProgramChildResult
} = Function.dual(2, (state: RuntimeState, input: AdmitProgramChildInput) =>
  Effect.gen(function* () {
...
type AdmitChildrenResult = Effect.Effect<
  readonly [ReadonlyArray<RunReceipt>, RuntimeState],
  | RunNotFound
  | RunTerminal
  | IdempotencyConflict
  | RunIdConflict
...
export const admitProgramChildrenAndSuspend: {
  (input: AdmitChildrenInput): (state: RuntimeState) => AdmitChildrenResult
  (state: RuntimeState, input: AdmitChildrenInput): AdmitChildrenResult
} = Function.dual(2, (state: RuntimeState, input: AdmitChildrenInput) =>
  Effect.gen(function* () {
