...
/** @experimental Wrap a model so TenetKit can validate tool calls before output escapes. */
export const wrap: {
  (
    original: Toolkit.Any,
...
/** @experimental Test whether a failure is the precise TenetKit-owned correction signal. */
