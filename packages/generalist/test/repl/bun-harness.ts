...
/** The Generalist workspace root cells resolve imports and `require` against. */
...
export const makeHarness = (
  ...
  Effect.gen(function* () {
    ...
    const dataRoot = yield* fileSystem.makeTempDirectoryScoped({ prefix: "generalist-kernel-" })
