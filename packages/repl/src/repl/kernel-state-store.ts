...
export class KernelStateUnavailable extends Schema.TaggedErrorClass<KernelStateUnavailable>()(
  "@batonfx/repl/KernelStateUnavailable",
  {
...
/**
 * @experimental Best-effort namespace persistence. Never durable authority: Baton operations,
...
export class KernelStateStore extends Context.Service<KernelStateStore, Interface>()(
  "@batonfx/repl/repl/kernel-state-store/KernelStateStore",
) {}
