...
> `const` **AdmissionPolicy**: `Schema.Literals`\<readonly \[`"steer"`, `"interrupt"`, `"rollback"`, `"reject"`\]\>
...
> `const` **ExecutionContinuation**: `Schema.Struct`\<\{ `nextTurn`: `Schema.Int`; `prompt`: `Schema.Codec`\<`Prompt.Prompt`, `Prompt.PromptEncoded`, `never`, `never`\>; `queue`: `Schema.optionalKey`\<`Schema.Literal`\<`"steering"`\>\>; `schemaVersion`: `Schema.Literal`\<`1`\>; `steeringEntryIds`: `Schema.$Array`\<`Schema.String`\>; \}\>
