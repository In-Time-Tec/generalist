    ...
    table(
      ...
      [
        ...
        [
          ...
          "disabled",
          [
            "Enables overflow summarization. Provide ",
            code("summarize.model"),
            " as a closed LanguageModel layer, or omit it and the layer requires the ambient ",
            code("LanguageModel"),
          ],
        ],
        [[code("summarize.prompt")], "built-in summary prompt", "Instruction for folding overflow into the summary"],
        [[code("summarize.model")], "none", ["Closed ", code("Layer<LanguageModel>"), " for summary calls"]],
      ],
    ),
