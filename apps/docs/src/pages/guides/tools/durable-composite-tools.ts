import admitAndJoin from "virtual:source/src/snippets/guides/tools/child-admission/admit-and-join.ts"
import journalACrossing from "virtual:source/src/snippets/guides/agent/nested-operations/journal-a-crossing.ts"
import { bullets, callout, code, codeBlock, definePage, h2, link, p, table } from "../../../prose"

const paging = `import { SessionHistory } from "generalist"
