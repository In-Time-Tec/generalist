import "./suites/admit-suite.js"
import "./suites/cancel-suite.js"
import "./suites/fan-out-suite.js"
import "./suites/messaging-suite.js"
import "./suites/operation-suite.js"
...
import { SCHEMA_META_TABLE, SCHEMA_VERSION, schemaChecksum } from "../../../src/pg/schema.js"
import {
...
type EncodableJson = Schema.Json | typeof alternateAssistantRef.ref | typeof alternateAssistantRef.manifest
const encodeJson = (value: EncodableJson): string => Schema.encodeSync(Schema.fromJsonString(Schema.Unknown))(value)
const decodeJson = (text: string) => ({ ...Schema.decodeSync(JsonObject)(text) })
...
const corruptEventExecutableRef = (runId: string, executableRef: Schema.Json) =>
  Effect.gen(function* () {
    const sql = yield* SqlClient.SqlClient
  ...
  it.live("releases only the exact execution claim and permits immediate replacement", () =>
    withSchema(
      Effect.gen(function* () {
        ...
        expect(released.updated_at).not.toContain("2000-01-01")
