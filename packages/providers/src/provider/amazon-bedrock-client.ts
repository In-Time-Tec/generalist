...
/** @experimental */
export class ClientFailure extends Schema.TaggedErrorClass<ClientFailure>()(
  "@batonfx/providers/AmazonBedrockClientFailure",
  {
...
export class RecoveryFailure extends Schema.TaggedErrorClass<RecoveryFailure>()(
  "@batonfx/providers/AmazonBedrockRecoveryFailure",
  { description: Schema.String },
) {}
...
/** @experimental */
export class Client extends Context.Service<Client, Interface>()("@batonfx/providers/provider/amazon-bedrock-client/Client") {}
