...
export const providersReference = definePage({
  ...
  content: [
    ...
    command("Install core", "bun add effect@4.0.0-rc.112 generalist"),
    p(
    ...
    table(
      ...
      [
        ...
        [
          [code("./anthropic")],
          [code("layerModel"), ", ", code("layerConfig"), ", ", code("layer"), ", ", code("decodeConfig")],
        ],
        [
          [code("./amazon-bedrock")],
          [code("layerModel"), ", ", code("layerClient"), ", ", code("layer"), ", ", code("decodeConfig")],
        ],
        [
          [code("./openrouter")],
          [code("layerModel"), ", ", code("layerConfig"), ", ", code("layer"), ", ", code("decodeConfig")],
        ...
        [[code("./deterministic")], [code("layerModel"), ", ", code("layer")]],
    ...
    h2("model-layers", "Model layers (layerModel)"),
    p(
      "Every provider exports ",
      code("layerModel({ model, ... })"),
      ": a closed-over-its-client ",
      code("Layer"),
      " providing ",
      code("LanguageModel"),
      " plus the ",
      ...
      " and ",
      code("ModelName"),
      " telemetry tags. Provide it directly to a run with ",
      code("Effect.provide"),
      " — this is the default wiring. The underlying client layer (",
      code("layerConfig"),
      ", or ",
      code("layerClient"),
      " for Bedrock) stays separate, so the model layer composes over any compatible client. Failure classification, image-source handling, and tool-schema compilation are baked into the model layer.",
    ),
    ...
    callout(
      ...
      "Provider ",
      code("layer"),
      " constructors return registry layers, not LanguageModel layers; wrap the run in ",
      code("ModelRegistry.withModel({ provider, model }, effect)"),
      " to resolve the selection. Prefer ",
      code("layerModel"),
      " when the model is known at construction — it provides LanguageModel directly.",
    ),
    ...
    table(
      ...
      [
        [
          [code("layerModel(input?)")],
          [
            "LanguageModel layer for a scripted model that always answers ",
            code('"deterministic response"'),
            "; provide directly with ",
            code("Effect.provide"),
        ...
        [
          [code("layer(input?)")],
          ["Registry layer for the same scripted model, for ", code("ModelRegistry.withModel"), " selection"],
        ],
        [
