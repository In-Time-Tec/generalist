import pinSnapshot from "virtual:source/src/snippets/guides/agent/instruction-guidance/pin-a-snapshot.ts"
import pinSnapshotExpected from "virtual:source/src/snippets/guides/agent/instruction-guidance/pin-a-snapshot.expected.txt"
import refine from "virtual:source/src/snippets/guides/agent/instruction-guidance/refine-and-roll-back.ts"
import refineExpected from "virtual:source/src/snippets/guides/agent/instruction-guidance/refine-and-roll-back.expected.txt"
...
export const instructionGuidance = definePage({
  path: "/docs/guides/instruction-guidance",
  title: "Let an agent refine its own guidance",
  navTitle: "Instruction guidance",
  group: "Guides",
  description:
  ...
  content: [
    p(
      ...
      " is the engine for versioned instructions an agent may refine and a host may pin: prompt notes, memories, skills, and subagent specs, each versioned and audited. Store locations, scope policy, and the refine flow itself stay host-owned.",
    ),
    ...
    p(
      ...
      link("/docs/reference/instruction-guidance", "the generalist/instructions reference"),
