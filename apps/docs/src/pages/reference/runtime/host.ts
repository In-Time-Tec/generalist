  ...
  content: [
    ...
    table(
      ...
      [
        ...
        [[code("@tenetkit/pg RunSchema")], "PostgreSQL schema plan, check, and predeploy apply operations"],
        [[code("@tenetkit/mysql RunSchema")], "MySQL schema plan, check, predeploy apply, and dirty-state operations"],
