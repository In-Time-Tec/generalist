...
const bunInstall = `bun add effect@4.0.0-rc.111 tenetkit@0.37.0`

const otherManagers = `npm install effect@4.0.0-rc.111 tenetkit@0.37.0
pnpm add effect@4.0.0-rc.111 tenetkit@0.37.0`
...
export const installation = definePage({
  ...
  group: "Start",
  description: "Install the TenetKit 0.37 release train with its exact Effect release candidate.",
  content: [
    lead(
    ...
    callout(
      ...
      "TenetKit 0.37.x is built and tested against ",
    ...
    table(
      ...
      [
        ...
        [[code("tenetkit/runtime")], "0.37.0", "Addressable Runs, replay, inspection, waits, and stores"],
        [[code("tenetkit/mcp")], "0.37.0", "MCP discovery and the TenetKit ToolExecutor adapter"],
        [[code("tenetkit/skills")], "0.37.0", "SKILL.md and instruction-file sources"],
        [[code("tenetkit/memory")], "0.37.0", "Working memory, vector store, and semantic recall"],
        [[code("tenetkit/test")], "0.37.0", "Scripted model fixtures and normalized request capture"],
        [
          [code("tenetkit/transport")],
          "0.37.0",
          "Runtime wire codecs, snapshots, SSE and WebSocket serving, and client adapters",
        ],
        [[code("tenetkit/foldkit")], "0.37.0", "FoldKit connection service and headless chat model"],
        [[code("tenetkit/a2a")], "0.37.0", "A2A v1 server projection over Runtime"],
        [[code("tenetkit/ag-ui")], "0.37.0", "AG-UI event projection over Runtime"],
      ],
    ),
    h2("effect-compatibility", "Effect compatibility"),
    table(["TenetKit release", "Tested Effect version"], [[[code("0.37.x")], [code("effect@4.0.0-rc.111")]]]),
