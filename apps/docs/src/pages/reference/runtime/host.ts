  ...
  content: [
    ...
    table(
      ...
      [
        ...
        [[code("tenetkit/runtime/driver/sql/run/claims")], [code("RunClaims"), " multi-worker claims and leases"]],
        [[code("tenetkit/runtime/driver/sql/worker")], [code("RuntimeWorker"), " hosted worker loops"]],
