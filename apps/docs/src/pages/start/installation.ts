...
const bunInstall = `bun add effect@4.0.0-rc.112 tenetkit@0.43.0`

const otherManagers = `npm install effect@4.0.0-rc.112 tenetkit@0.43.0
pnpm add effect@4.0.0-rc.112 tenetkit@0.43.0`
...
export const installation = definePage({
  ...
  group: "Start",
  description: "Install TenetKit 0.43.0 with its exact Effect peer and only the adapters and peers you use.",
  content: [
    lead(
      "Most projects install effect and tenetkit, then import exact tenetkit/* subpaths. PostgreSQL, MySQL, and Cloudflare are separate lockstep adapter packages.",
    ),
    ...
    callout(
      ...
      "TenetKit 0.43.0 is built and tested against ",
    ...
    p("The release train contains exactly four installable packages. Keep installed TenetKit packages on one version."),
    table(
      ...
      [
        ...
        [[code("@tenetkit/pg")], "0.43.0", "Node 22+ and Bun 1.4+: PostgreSQL Runtime layer and RunSchema"],
        [[code("@tenetkit/mysql")], "0.43.0", "Node 22+ and Bun 1.4+: MySQL Runtime layer and RunSchema"],
        [[code("@tenetkit/cloudflare")], "0.43.0", "Cloudflare Worker subpaths; the package root is not exported"],
      ],
    ),
    ...
    table(["TenetKit release", "Tested Effect version"], [[[code("0.43.0")], [code("effect@4.0.0-rc.112")]]]),
    ...
    callout(
      ...
      code("@experimental"),
      " tag: APIs can change in any 0.x release. The four packages release in lockstep, so keep them on the same version.",
    ),
    p(
      "Installed? ",
