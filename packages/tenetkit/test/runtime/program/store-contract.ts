...
import { Errors, RunExecutor, RunClaims, Runtime, RunStore } from "../../../src/runtime/index.js"
...
export const programReplayDivergenceContract: Effect.Effect<void, ProgramContractError, ProgramContractServices> =
  Effect.gen(function* () {
    ...
    expect(divergence).toMatchObject({ _tag: "tenetkit/core/ProgramReplayDivergence", operation: "same-operation" })
...
export const programCancellationFinalizerContract: Effect.Effect<void, ProgramContractError, ProgramContractServices> =
  Effect.gen(function* () {
    ...
    expect(settled).toMatchObject({
      status: "failed",
      error: { _tag: "tenetkit/core/ProgramCancelled", reason },
    })
    expect(
