...
export const testIdentity: Identity = declareIdentity({
  provider: "tenetkit",
  implementation: { name: "tenetkit/SandboxExecutor/test", version: "1" },
...
/** @experimental Trusted fixture executor for tests only. */
export const make = (execute: TestExecute): Interface =>
  SandboxExecutor.of({
...
export const layerTest = (execute: TestExecute): Layer.Layer<SandboxExecutor> =>
  Layer.succeed(SandboxExecutor, make(execute))
