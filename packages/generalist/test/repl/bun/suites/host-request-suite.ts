...
class SlowFailure extends Schema.TaggedError<SlowFailure>()("generalist/repl/test/SlowFailure", {
...
const textModule: HostBindings.Module = {
  name: "workspace",
  operations: [
    {
      name: "read",
...
const echoModule: HostBindings.Module = {
  name: "host",
  operations: [
    {
      name: "echo",
