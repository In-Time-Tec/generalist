...
export const a2aReference = definePage({
  ...
  content: [
    lead("@batonfx/a2a maps A2A v1 tasks onto Runtime runs without storing a second lifecycle."),
    command("Install", "bun add @a2a-js/sdk@1.0.1 @batonfx/runtime @batonfx/a2a"),
