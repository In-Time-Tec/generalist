...
const { loadEntries, pathFromRows, storeError } = PostgresSessionStorage
...
/** Read-only PostgreSQL Session hydration with no mutation capability. */
export const postgresSessionReader = (options: {
