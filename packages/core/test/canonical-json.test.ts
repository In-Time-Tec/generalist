...
import { digest, sha256Text } from "../src/durable/canonical-json.js"
...
const referenceDigest = (value: unknown): string => referenceSha256Text(digestText(value))

const canonical = (input: unknown): unknown => {
  if (input === null || typeof input !== "object") return Object.is(input, -0) ? 0 : input
...
const digestText = (value: unknown): string => JSON.stringify(canonical(value))

const valueCases: ReadonlyArray<unknown> = [
  null,
  true,
  false,
  0,
