...
import { Snapshot, State } from "../../src/instructions/index.js"
...
describe("Snapshot", () => {
  ...
  it.effect("fails when the payload does not reconstruct the pinned snapshot", () =>
    Effect.gen(function* () {
      ...
      if (failure._tag !== "generalist/instructions/SnapshotMismatch") return
  ...
  it("names a stable codec and version for durable registrations", () => {
    expect(Snapshot.codec).toBe("generalist/instructions/snapshot")
