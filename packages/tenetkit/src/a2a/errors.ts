...
export class MessageRejected extends Schema.TaggedErrorClass<MessageRejected>()("tenetkit/a2a/MessageRejected", {
  message: Schema.String,
  part: Schema.optionalKey(Schema.Int),
}) {}

/** @experimental The task is not in a waitable state for the requested operation. */
export class TaskNotWaiting extends Schema.TaggedErrorClass<TaskNotWaiting>()("tenetkit/a2a/TaskNotWaiting", {
