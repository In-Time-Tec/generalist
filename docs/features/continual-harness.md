...
- Each applied edit records exact before and after entries, so `Refinement.rollbackProposal` produces the inverse proposal that restores the earlier snapshot exactly.
