...
import { assistantRef, registrationsFor, textPrompt } from "../../tenetkit/test/runtime/helpers.js"
import { provideScoped } from "../../tenetkit/test/runtime/scoped-provide.js"
import { stagedRootSuite } from "../../tenetkit/test/runtime/staged-root-suite.js"
...
stagedRootSuite({ name: "postgres", storeLayer, skip: !postgresAvailable })
