...
export const ToolAuthorization = {
  ...
  ToolAuthorizerService: ToolAuthorization_ToolAuthorizerService,
  make: ToolAuthorization_make,
  layerTest: ToolAuthorization_layerTest,
} as typeof import("./tool-authorization.js")
export namespace ToolAuthorization {
  ...
  export type ToolAuthorizerService = import("./tool-authorization.js").ToolAuthorizerService
  ...
  export type ToolAuthorization = import("./tool-authorization.js").ToolAuthorization
  export type ToolAuthorizer<R = never> = import("./tool-authorization.js").ToolAuthorizer<R>
}
