...
export const installation = definePage({
  ...
  content: [
    ...
    p(
      ...
      ", and ",
      code("generalist/providers/deterministic"),
    ...
    table(
      ...
      [
        ...
        [[code("generalist/unstable/cloudflare/workers")], "None beyond effect", "Cloudflare Workers"],
        [
          [code("generalist/unstable/cloudflare/durable-objects")],
          [code("@effect/sql-sqlite-do@4.0.0-rc.112")],
          "Cloudflare Workers",
        ],
        [
          [code("generalist/unstable/cloudflare/dynamic-workers")],
          [code("es-module-lexer@2.3.2")],
          "Cloudflare Workers",
        ],
        [
          [code("generalist/unstable/rivet")],
        ...
        [
          ...
          [code("@modelcontextprotocol/sdk@1.29.0")],
          "Node, Bun; HTTP is Worker-safe",
        ],
        [[code("generalist/unstable/foldkit")], [code("foldkit@0.148.2")], "Node and Bun"],
        [[code("generalist/unstable/a2a")], [code("@a2a-js/sdk@1.0.1")], "Node and Bun"],
        [[code("generalist/unstable/ag-ui")], [code("@ag-ui/core@0.0.57")], "Node and Bun"],
        [
          [code("generalist/providers/<provider>")],
