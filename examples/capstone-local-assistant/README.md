...
1. Start an HTTP server with `@batonfx/transport` SSE and WebSocket handlers.
2. Render a FoldKit chat page backed by `@batonfx/foldkit` resources and subscriptions.
