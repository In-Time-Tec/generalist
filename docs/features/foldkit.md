...
`generalist/foldkit` adapts Generalist transport into FoldKit resources, subscriptions, commands, and a headless chat model. It does not own styled views, durable sessions, or execution semantics.
