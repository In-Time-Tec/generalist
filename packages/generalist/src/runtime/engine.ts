...
import type { CommandIdentity } from "./run/store-types.js"
...
export interface RuntimeInspection extends RunInspection {
  ...
  readonly waitOpenedAtSequence: Readonly<Record<string, number>>
...
export interface CancelInput extends CommandIdentity {
  readonly runId: string
  readonly reason?: string
}

export interface CancelSessionInput extends CommandIdentity {
  readonly sessionId: string
  readonly reason?: string
}
...
export type ScheduleError =
  ...
  | RuntimeAvailabilityError
  | DurabilityFailure
export type WakeError = RunNotFound | RunTerminal | RuntimeAvailabilityError | DurabilityFailure | WakeEventInvalid
/** Exact-root staged admission failures. */
export type AdmitError = StartExecutionError
/** Staged root activation failures. */
export type ActivateError = RunNotFound | RuntimeAvailabilityError | DurabilityFailure
...
export type RespondApprovalError =
  ...
  | RuntimeAvailabilityError
  | DurabilityFailure
export type SignalError = RunNotFound | WaitNotOpen | RunTerminal | RuntimeAvailabilityError | DurabilityFailure
export type CancelError = RunNotFound | RuntimeAvailabilityError | DurabilityFailure
...
export type ResolveOperationError =
  | RunNotFound
  | OperationResolutionConflict
  | RuntimeAvailabilityError
  | DurabilityFailure
...
export type RewindError =
  ...
  | RuntimeAvailabilityError
  | DurabilityFailure
export type ExtendBudgetError = RunNotFound | RuntimeAvailabilityError | DurabilityFailure | BudgetInvalid
...
export type OperatorReadError = InspectError | RuntimeAvailabilityError

export interface OperatorService {
  readonly explain: (runId: string) => Effect.Effect<RecoveryExplanation, OperatorReadError>
  readonly verify: (runId: string) => Effect.Effect<RecoveryVerification, OperatorReadError>
  ...
  readonly scanObligations: () => Stream.Stream<RecoveryObligation, OperatorReadError>
...
export interface Service extends RuntimeHostSessions {
  readonly hold: import("./application.js").Service["hold"]
  readonly sessions: import("./application.js").SessionService
  ...
  readonly recordReward: (input: RewardInput & CommandIdentity) => Effect.Effect<void, RecordRewardError>
...
export class Runtime extends Context.Service<Runtime, Service>()("generalist/runtime/engine/Runtime") {}
