  ...
  content: [
    ...
    table(
      ...
      [
        ...
        [[code("./openai")], [code("layer"), ", ", code("registration"), ", ", code("layerConfig")]],
        [
          [code("./openai-account")],
          [code("credentialsFromAuth"), ", ", code("registration"), ", ", code("layer"), ", ", code("layerClient")],
        ],
        [
        ...
        [[code("./model-catalog")], [code("ModelCatalog"), " service, ", code("bundled"), " metadata, layers"]],
      ],
    ),
    ...
    table(
      ...
      [
        [
          [code("layerOpenAI({ model, apiKey, clientConfig?, config? })")],
          [code("Ai.EmbeddingModel"), " layer over the OpenAI client requiring ", code("HttpClient")],
        ],
        [
          [code("layerOpenAICompatible({ model, baseUrl, apiKey?, clientConfig?, config? })")],
