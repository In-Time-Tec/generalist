import { type Deployment as A2A_Deployment, makeHandler as A2A_makeHandler } from "./adapter.js"
import { A2A as A2A_A2A, type Interface as A2A_Interface, layer as A2A_layer } from "./service.js"
export const A2A = {
  A2A: A2A_A2A,
  layer: A2A_layer,
  makeHandler: A2A_makeHandler,
} as typeof import("./service.js") & typeof import("./adapter.js")
...
export const Content = { decode: Content_decode } as typeof import("./content.js")
...
} as typeof import("./projection.js")
