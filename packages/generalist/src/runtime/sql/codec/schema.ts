...
export const SCHEMA_STATEMENTS: ReadonlyArray<string> = [
  ...
  UNIQUE (child_run_id),
  FOREIGN KEY (parent_run_id) REFERENCES generalist_runs(run_id),
  FOREIGN KEY (child_run_id) REFERENCES generalist_runs(run_id)
)`,
  ...
  `CREATE INDEX IF NOT EXISTS generalist_external_child_placements_parent_idx ON generalist_external_child_placements(parent_run_id, settlement_id, created_at)`,
  ...
  `CREATE INDEX IF NOT EXISTS generalist_run_steering_pending_idx ON generalist_run_steering(run_id, consumed_operation_id, discarded_reason, sequence)`,
  ...
  `CREATE INDEX IF NOT EXISTS generalist_messages_pending_idx ON generalist_messages(target_session_id, delivered_run_id, sequence)`,
  `CREATE INDEX IF NOT EXISTS generalist_runs_lane_idx ON generalist_runs(session_id, status)`,
  `CREATE INDEX IF NOT EXISTS generalist_runs_schedule_idx ON generalist_runs(status, created_at, run_id)`,
  ...
  FOREIGN KEY (fan_out_id) REFERENCES generalist_fan_outs(fan_out_id),
  FOREIGN KEY (child_run_id) REFERENCES generalist_runs(run_id)
)`,
  ...
  FOREIGN KEY (root_run_id) REFERENCES generalist_runs(run_id)
)`,
  ...
  FOREIGN KEY (root_run_id) REFERENCES generalist_tree_roots(root_run_id),
  FOREIGN KEY (run_id, run_sequence) REFERENCES generalist_run_events(run_id, sequence),
  FOREIGN KEY (event_id) REFERENCES generalist_run_events(event_id)
  )`,
  ...
  FOREIGN KEY (run_id) REFERENCES generalist_program_runs(run_id)
)`,
  ...
  FOREIGN KEY (run_id) REFERENCES generalist_runs(run_id),
  FOREIGN KEY (pin) REFERENCES generalist_executable_registrations(pin)
  )`,
