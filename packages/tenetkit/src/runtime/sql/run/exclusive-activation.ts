...
const drainDuration = Metric.timer("tenetkit_runtime_sqlite_activation_drain_duration", {
  description: "Exclusive SQLite Runtime activation drain duration",
  attributes: { backend: "sqlite-exclusive-host" },
})

const drainSize = Metric.histogram("tenetkit_runtime_sqlite_activation_drain_size", {
...
const drainOutcomes = Metric.frequency("tenetkit_runtime_sqlite_activation_drain_outcomes", {
...
const rearms = Metric.counter("tenetkit_runtime_sqlite_activation_rearms", {
