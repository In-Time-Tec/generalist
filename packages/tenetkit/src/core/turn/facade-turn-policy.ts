...
export namespace TurnPolicy {
  ...
  export type TurnPolicyError = import("./policy.js").TurnPolicyError
  ...
  export type Policy = import("./policy.js").Policy
  ...
  export type TurnPolicy<R = never> = import("./policy.js").TurnPolicy<R>
