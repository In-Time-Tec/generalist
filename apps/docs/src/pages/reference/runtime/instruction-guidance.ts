...
export const instructionGuidanceReference = definePage({
  path: "/docs/reference/instruction-guidance",
  title: "generalist/instructions",
  navTitle: "instruction guidance",
  group: "Reference",
  description:
    "The instruction guidance engine: versioned entries, audited refinements, rollback, scope merge, bounded overview, and content-addressed snapshots.",
  content: [
    lead(
    ...
    p(
      ...
      code("generalist/instructions/snapshot"),
      ", version ",
      code("1"),
      ", and ",
    ...
    p(
      ...
      link("/docs/reference/core-context", "generalist context"),
