# Keep TenetKit Runtime as the durable substrate

TenetKit Runtime remains the sole scheduler, journal, claim, wait, and recovery authority. Do not place Effect Workflow or Cluster around a durable Run while retaining TenetKit state to supply missing execution guarantees.
