...
export const AgentName = Schema.String.check(Schema.isPattern(/^[a-z0-9][a-z0-9._-]{0,63}$/)).pipe(
  Schema.brand("@batonfx/runtime/AgentName"),
)
/** @experimental */
...
export class AddressInvalid extends Schema.TaggedErrorClass<AddressInvalid>()("@batonfx/runtime/AddressInvalid", {
  address: Address,
