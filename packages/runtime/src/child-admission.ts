...
export class ChildParentageInvalid extends Schema.TaggedErrorClass<ChildParentageInvalid>()(
  "@batonfx/runtime/ChildParentageInvalid",
...
export class AgentChildren extends Context.Service<AgentChildren, AgentChildrenInterface>()(
  "@batonfx/runtime/child-admission/AgentChildren",
) {}
