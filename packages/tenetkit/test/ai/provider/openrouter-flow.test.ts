...
import { Agent, ModelResilience } from "tenetkit"
import { decodeConfig, layer } from "tenetkit/ai/openrouter"
...
describe("OpenRouter public flow", () => {
  it.effect("exposes bounded OpenRouter billing metadata through the public Agent flow without prompts", () => {
    ...
    return Effect.gen(function* () {
      ...
      expect(JSON.stringify(completed)).not.toContain("prompt-secret")
