import step1 from "../../snippets/cell-agent/step-1.sh?raw"
import step2 from "../../snippets/cell-agent/step-2.ts?raw"
import step2Expected from "../../snippets/cell-agent/step-2.expected.txt?raw"
import step3 from "../../snippets/cell-agent/step-3.ts?raw"
import step3Expected from "../../snippets/cell-agent/step-3.expected.txt?raw"
import step4 from "../../snippets/cell-agent/step-4.ts?raw"
import step4Expected from "../../snippets/cell-agent/step-4.expected.txt?raw"
import step5 from "../../snippets/cell-agent/step-5.ts?raw"
...
export const cellAgent = definePage({
  ...
  content: [
    ...
    p(code("@batonfx/repl"), "'s root export is contracts only, so nothing so far touches a process."),
    ...
    p(
      ...
      link("/docs/reference/repl", "the @batonfx/repl reference"),
