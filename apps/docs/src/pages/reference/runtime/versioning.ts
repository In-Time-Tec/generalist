...
export const versioningReference = definePage({
  ...
  content: [
    lead("The five TenetKit packages publish to npm as a coordinated train at the same version."),
    ...
    table(
      ...
      [
        ...
        [[code("@tenetkit/rivet")], [code(version)], [code("./actors")]],
      ],
    ),
    ...
    pills(["tenetkit", "@tenetkit/pg", "@tenetkit/mysql", "@tenetkit/cloudflare", "@tenetkit/rivet"]),
    p(
