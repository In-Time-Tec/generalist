type DurableDriverFacade = typeof import("./durable-driver.js") &
  typeof import("./driver-contract.js") &
  typeof import("./driver-tracer.js") &
  typeof import("./driver-interpreter.js") &
  typeof import("./loop-driver.js") &
  typeof import("./driver-run.js")
...
import {
  ...
  makeOperation as DurableDriver_makeOperation,
...
import {
  ...
  makeTracer as DurableDriver_makeTracer,
...
import {
  ...
  makeInline as DurableDriver_makeInline,
...
import { makeLoopDriver as DurableDriver_makeLoopDriver } from "./loop-driver.js"
import {
...
export namespace DurableDriver {
  ...
  export type makeOperation = typeof import("./driver-contract.js").makeOperation
  ...
  export type DriverError = import("./durable-driver.js").DriverError
  export type DriverVersionMismatch = import("./durable-driver.js").DriverVersionMismatch
  export type DriverStateInvalid = import("./durable-driver.js").DriverStateInvalid
  export type DriverInput = import("./durable-driver.js").DriverInput
  export type DurableAgentDriver = import("./durable-driver.js").DurableAgentDriver
  export type requireDriverVersion = typeof import("./durable-driver.js").requireDriverVersion
  ...
  export type makeTracer = typeof import("./driver-tracer.js").makeTracer
  ...
  export type makeLoopDriver = typeof import("./loop-driver.js").makeLoopDriver
