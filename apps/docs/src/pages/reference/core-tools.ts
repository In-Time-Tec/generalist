...
export const coreToolsReference = definePage({
  ...
  content: [
    ...
    p(
      ...
      code("execute: (request: Request) => Effect<Outcome, AgentError | RemoteRetryError, ToolContext>"),
      ". Direct executor consumers observe the typed retry error; the Agent loop wraps it in ",
      code("AgentError"),
      " and retains it as the cause.",
    ),
    table(
    ...
    p(
      ...
      code("success"),
      " schema before Baton re-feeds the result to the model.",
    ),
    p(
