...
import { type FrameWithoutSeq, makeFrameJournal } from "../transport/frame-journal.js"
import {
  coordination,
...
import type { ClientApproval, LooseServerFrameType, SessionStatus } from "../transport/wire.js"
const {
  errorMessage,
  infoFrom,
  nonNegativeInteger,
