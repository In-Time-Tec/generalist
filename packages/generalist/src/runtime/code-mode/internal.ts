...
} from "../../core/durable/manifest/program-manifest.js"
...
const closureFor = (manifest: ExecutableManifest, roots: ReadonlyArray<ProgramAgentCapability>): ExecutableClosure => {
...
export const make = (input: {
  ...
  const prepare = (request: Parameters & { readonly toolCallId: string }) =>
    Effect.gen(function* () {
      ...
      const closure = closureFor(input.claimed.executableManifest, agents)
