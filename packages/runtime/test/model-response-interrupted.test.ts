...
import { Agent, Compaction, ModelResilience, Pins } from "@batonfx/core"
import { Address, Cursor, Errors, ExecutableResolver, ExecutionHost, Runtime, RunStore } from "../src/index.js"
      ...
      yield* scopedWith(hosted.layer)(
        Effect.gen(function* () {
          ...
          expect(
            ...
            status: "failed",
            error: { _tag: "@batonfx/runtime/AgentExecutionFailure", message: "execution interrupted" },
          })
