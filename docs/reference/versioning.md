...
| ------------ | -------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `generalist` | `0.63.0` | Core, Runtime, exact AI leaves, MCP, memory, instructions and skills, test hosts, transport, integrations, and the `./pg`, `./mysql`, `./unstable/cloudflare/workers`, `./unstable/cloudflare/durable-objects`, `./unstable/cloudflare/dynamic-workers`, and `./unstable/rivet` adapters |
...
| ---------- | -------------- | --------------------------------------------------- |
| `0.63.0`   | `4.0.0-rc.112` | The exact peer and tested workspace catalog version |
