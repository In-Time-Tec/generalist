...
The install command targets unpublished 0.65.0; see [Installation](/start/installation) before using the registry. The [repository examples](/start/examples) run against the current workspace.
...
bun init -y
bun add effect@4.0.0-rc.112 generalist@0.65.0 @effect/platform-bun@4.0.0-rc.112
```
