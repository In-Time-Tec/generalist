...
const content = { codec: "@batonfx/harness/snapshot", version: "1", digest: Pins.digest(payload) }
...
describe("AgentManifest pinned capability content", () => {
  ...
  it("round-trips a named capability with pinned content", () => {
    ...
    expect(Schema.decodeUnknownSync(AgentManifest.NamedCapability)(encoded)).toEqual(capability)
  })
