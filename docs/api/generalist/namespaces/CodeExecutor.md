...
[generalist](../../index.md) / [generalist](../index.md) / CodeExecutor
...
> **TestExecute** = (`request`) => `Effect.Effect`\<`unknown`, [`ExecutionFailure`](#executionfailure), [`ProgramCapabilities`](./ProgramCapabilities.md#programcapabilities) \| `Scope.Scope`\>
...
`Effect.Effect`\<`unknown`, [`ExecutionFailure`](#executionfailure), [`ProgramCapabilities`](./ProgramCapabilities.md#programcapabilities) \| `Scope.Scope`\>
