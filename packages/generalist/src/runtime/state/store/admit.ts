...
import { idempotencyKey, laneKey, type RuntimeState, type StoredRun } from "../state.js"
...
type AdmitSendResult = Effect.Effect<
  ...
  IdempotencyConflict | RunIdConflict | ExecutableRegistrationConflict | RuntimeUnavailable | TreePolicyInvalid, PreparedObservation
>
...
type AdmitStartResult = Effect.Effect<
  ...
  | FanOutRemainderUnsupported
  | RuntimeUnavailable
  | TreePolicyInvalid, PreparedObservation
>
